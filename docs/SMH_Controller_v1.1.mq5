#property copyright "SMH Controller v1.1"
...
input string ApiKey           = "ISI_API_KEY";
...
bool ProcessCommand(string command, string &outMsg)
{
   ...
   if(CmdStartsWith(command,"setmultiplier"))
   {
      ...
      double v=StringToDouble(ns); if(v<1.1){ outMsg="min 1.1"; return false; } if(v>10){ outMsg="max 10"; return false; }
   ...
   Print("[CMD] UNKNOWN: ",command," (need Controller v1.15+ for tradetime/tradestart/tradeend)");
   return false;
}
